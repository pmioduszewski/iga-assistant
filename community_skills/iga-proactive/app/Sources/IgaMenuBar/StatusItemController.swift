...
final class StatusItemController: NSObject {
    ...
    init(panel: PanelController, store: StateStore) {
        ...
        if let button = statusItem.button {
            ...
            button.toolTip = "Iga — click to show/hide"
            // We handle left-click only; keep it simple and predictable.
    ...
    @objc private func statusItemClicked(_ sender: Any?) {
        // ONE click toggles BOTH panels together (one window → atomic).
        panel.toggle()
